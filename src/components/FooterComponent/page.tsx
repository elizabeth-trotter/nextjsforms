...
const FooterComponent = () => {
    return (
        <div className="bg-[#737375]  py-[30px] ">
            <div className=" grid grid-cols-1 md:grid-cols-3 mx-auto  max-w-[1200px]">
                ...
                <div className="  py-[20px] border-r border-l border-[#9c9c9c] text-white px-[15px]">
                    <div>
                        ...
                        <a href="https://www.codestack.org/" target='_blank'><Image width={150} height={50} className="my-[5px]" src="/CodeStackFooter.png" alt="CodeStack Logo" /></a>
                        <a href="https://www.sjcoe.org/" target='_blank'><Image width={150} height={50} className=" my-[5px]" src="/SjcoeLogo.png" alt="SJCOE Logo" /></a>
                    </div>
                </div>

                <div className="  py-[20px] text-white px-[15px]">
                    <p className=" mb-[20px] robotoCondensed text-[22px]">CodeStack Sites</p>
                    <a href="https://codestack.org/" target='_blank' className='flex flex-row hover:underline'><Image width={22} height={22} className='mr-[10px]' src="/icon_codestack.png" alt="CodeStack Logo" />CodeStack</a>
                    <a href="https://seis.org/" target='_blank' className='flex flex-row hover:underline'><Image width={22} height={22} className='mr-[10px]' src="/icon_seis.png" alt="SEIS Logo" />SEIS</a>
                    <a href="https://edjoin.org/" target='_blank' className='flex flex-row hover:underline'><Image width={22} height={22} className='mr-[10px]' src="/icon_edjoin.png" alt="EDJOIN Logo" />EDJOIN</a>
                    <a href="https://mypromis.org/" target='_blank' className='flex flex-row hover:underline'><Image width={22} height={22} className='mr-[10px]' src="/icon_promis.png" alt="PROMIS Logo" />PROMIS</a>
                    <a href="https://sstonline.org/" target='_blank' className='flex flex-row hover:underline'><Image width={22} height={22} className='mr-[10px]' src="/icon_sst.png" alt="Beyond SST Logo" />Beyond SST</a>
                </div>
            </div>
        </div>
    )
